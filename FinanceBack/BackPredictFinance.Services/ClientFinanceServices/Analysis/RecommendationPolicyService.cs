...
{
/// <summary>
/// Décide la recommandation structurée à partir des faits analytiques et du portefeuille.
/// </summary>
public interface IRecommendationPolicyService
{
    /// <summary>
    /// Évalue une analyse pour produire la recommandation backend structurée.
    /// </summary>
    AnalysisRecommendation EvaluateAnalysis(AnalysisRequest request, IReadOnlyList<PatternAssessmentContract> compatiblePatterns, AnalysisOutcome outcome);
}


    /// <summary>
    /// Implémente la politique de recommandation technique contextualisée par le portefeuille.
    /// </summary>
    public sealed class RecommendationPolicyService : IRecommendationPolicyService
    {
        ...
        public AnalysisRecommendation EvaluateAnalysis(AnalysisRequest request, IReadOnlyList<PatternAssessmentContract> compatiblePatterns, AnalysisOutcome outcome)
        {
            ArgumentNullException.ThrowIfNull(request);
            ArgumentNullException.ThrowIfNull(compatiblePatterns);

            var holdingContext = request.PortfolioContext.HoldsInstrument ? HoldingStatusEnum.Held : HoldingStatusEnum.NotHeld;
            ...
            var recommendationDecision = _tradingRecommendationService.EvaluateAnalysis(
            ...
            var kind = ResolveRecommendationKind(request.PortfolioContext.HoldsInstrument, primaryPattern, recommendationDecision.Action);
            ...
            return new AnalysisRecommendation
            {
                ...
                BasedOnPatternIds = basedOnPatternIds,
                ReviewHorizonDays = recommendationDecision.HorizonDays > 0 ? recommendationDecision.HorizonDays : null,
                PolicyVersion = "analysis-v1-policy@prompt3",
        ...
        private static RecommendationKind ResolveRecommendationKind(bool holdsInstrument, PatternAssessmentContract primaryPattern, RecommendationActionEnum action)
        {
        ...
        private static string BuildRationale(RecommendationKind kind, PatternAssessmentContract patternAssessment, bool holdsInstrument)
        {
