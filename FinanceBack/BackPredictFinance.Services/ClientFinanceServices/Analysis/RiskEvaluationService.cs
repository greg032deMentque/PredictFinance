...
{
/// <summary>
/// Calcule les indications de risque dérivées d'un résultat de pattern.
/// </summary>
public interface IRiskEvaluationService
{
    /// <summary>
    /// Évalue le risque principal associé à un pattern dans un artefact d'exécution.
    /// </summary>
    ...
    /// <summary>
    /// Implémente la construction des stops, objectifs et ratios de risque.
    /// </summary>
