...
{
    /// <summary>
    /// Envoie les emails applicatifs et construit leurs pièces jointes.
    /// </summary>
    public interface IEmailService
    {
        ...
        /// <summary>
        /// Envoie un email générique avec contenu texte ou HTML.
        /// </summary>
        Task SendEmail(
            string userEmail,
            string subject,
        ...
        /// <summary>
        /// Construit une pièce jointe à partir d'un fichier local.
        /// </summary>
        EmailAttachment CreateAttachmentFromPath(string filePath);
    }

    /// <summary>
    /// Implémente l'envoi SMTP des emails sortants.
    /// </summary>
